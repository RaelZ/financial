...
export class InitialTables1709216032750 implements MigrationInterface {
  name = 'InitialTables1709216032750';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users_info" ADD CONSTRAINT "FK_7c6114f7c4c3029c1e73b3acabb" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "incomes" ADD CONSTRAINT "FK_f6b7c6bbe04a203dfc67ae627ab" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "expanses" ADD CONSTRAINT "FK_d315163dd4bf3488cfb2d03ae54" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "expanses" DROP CONSTRAINT "FK_d315163dd4bf3488cfb2d03ae54"`,
    );
    await queryRunner.query(
      `ALTER TABLE "incomes" DROP CONSTRAINT "FK_f6b7c6bbe04a203dfc67ae627ab"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users_info" DROP CONSTRAINT "FK_7c6114f7c4c3029c1e73b3acabb"`,
    );
    await queryRunner.query(
